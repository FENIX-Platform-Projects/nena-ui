define([
    ...
    ZONALSUM.prototype.createTable = function() {
        ...
        _.forEach( this.$region_dd.val(), function(code) {
            codes.push(parseInt(code));
        });


        request.raster[0].workspace = this.o.workspace;
        request.raster[0].layerName = this.o.layerName;
        request.vector.filter.codes = codes;
        //request.vector.filter.codes = [1543];
